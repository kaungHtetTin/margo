...
@section('page-title', 'Create Job Form')
...
<div class="container-fluid">
  ...
  <form action="{{ route('admin.job-forms.store') }}" method="POST">
    @csrf
    <div class="row">
      <div class="col-lg-8">
        <div class="admin-card">
          <div class="card-header">
            <h5 class="mb-0"><i class="fas fa-plus me-2"></i>Job Form Details</h5>
          </div>
          <div class="card-body">
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" placeholder="Enter job form title" required>
              @error('title')
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="6" placeholder="Enter job form description">{{ old('description') }}</textarea>
              @error('description')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="d-flex gap-2 mt-4">
          <button type="submit" class="btn btn-admin w-100">
            <i class="fas fa-save me-2"></i>Create Job Form
          </button>
        </div>
      </div>
    </div>
