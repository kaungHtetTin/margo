      ...
      <div class="col-lg-8">
        <div class="admin-card">
          <div class="card-header">
            <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Teacher Details</h5>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $teacher->name) }}" placeholder="Full name" required>
                @error('name')
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $teacher->email) }}" placeholder="email@example.com" required>
                @error('email')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone', $teacher->phone) }}" placeholder="Phone number">
              @error('phone')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control @error('bio') is-invalid @enderror" id="bio" name="bio" rows="4" placeholder="Short biography">{{ old('bio', $teacher->bio) }}</textarea>
              @error('bio')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control @error('specialization') is-invalid @enderror" id="specialization" name="specialization" value="{{ old('specialization', $teacher->specialization) }}" placeholder="e.g. Web Development">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control @error('qualification') is-invalid @enderror" id="qualification" name="qualification" value="{{ old('qualification', $teacher->qualification) }}" placeholder="e.g. MSc Computer Science">
                @error('qualification')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control @error('experience_years') is-invalid @enderror" id="experience_years" name="experience_years" value="{{ old('experience_years', $teacher->experience_years) }}" min="0" max="99" placeholder="0">
            ...
            <div class="mb-3">
              ...
              @if($teacher->image)
                <div style="margin-bottom: 12px;">
                  <img src="{{ storage_url($teacher->image) }}" alt="{{ $teacher->name }}" style="max-width: 120px; height: auto; border-radius: 8px; border: 1px solid var(--border-color);">
                  <small class="d-block text-muted" style="margin-top: 4px;">Current photo. Upload a new file to replace.</small>
                </div>
              @endif
              ...
              <small class="text-muted" style="font-size: 12px;">JPEG, PNG, GIF, WebP. Max 2MB. Leave empty to keep current.</small>
              @error('image')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
            ...
            @php
              $links = is_array($teacher->social_links) ? $teacher->social_links : [];
            @endphp
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="url" class="form-control" id="social_facebook" name="social_facebook" value="{{ old('social_facebook', $links['facebook'] ?? '') }}" placeholder="https://facebook.com/...">
              </div>
              <div class="col-md-6 mb-3">
                ...
                <input type="url" class="form-control" id="social_linkedin" name="social_linkedin" value="{{ old('social_linkedin', $links['linkedin'] ?? '') }}" placeholder="https://linkedin.com/in/...">
              </div>
              <div class="col-md-6 mb-3">
                ...
                <input type="url" class="form-control" id="social_twitter" name="social_twitter" value="{{ old('social_twitter', $links['twitter'] ?? '') }}" placeholder="https://twitter.com/...">
              </div>
              <div class="col-md-6 mb-3">
                ...
                <input type="url" class="form-control" id="social_instagram" name="social_instagram" value="{{ old('social_instagram', $links['instagram'] ?? '') }}" placeholder="https://instagram.com/...">
              </div>
            </div>
